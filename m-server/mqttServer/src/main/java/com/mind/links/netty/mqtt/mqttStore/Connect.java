...
import com.mind.links.netty.mqtt.mqttStore.message.DupPubRelMessageStore;
import com.mind.links.netty.mqtt.mqttStore.message.DupPublishMessageStore;
...
public class Connect {
    ...
    private final SessionStoreServiceImpl sessionStoreService;
    ...
    public void processConnect(Channel channel, MqttConnectMessage msg) {
        ...
        //  TODO: 2021/1/12   如果cleanSession为0, 需要重发同一clientId存储的未完成的QoS1和QoS2的DUP消息
