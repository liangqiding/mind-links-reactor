 ...
 */
public class LinksDtoFormat {
    /**
     * create by: lqd
     * description: TODO Conditional dynamic splicing
     * create time: 2020/9/11 0011 14:53
     * params：  * @Param: Object  o 条件实体类
     *
     * @return QueryWrapper<T>
     */
    public static <T> QueryWrapper<T> dtoFormat(Object o) throws Exception {
        try {
            ...
            throw new LinksException(30606, "查询条件异常");
        }
    }
     ...
     * @return user_name
     */
    public static String underscoreValue(String value) {
